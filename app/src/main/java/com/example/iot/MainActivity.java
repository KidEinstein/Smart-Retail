...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            priceValue = extras.getString("priceKey");
            priceValue_i = Integer.parseInt(priceValue);

        }

        int y = prefs.getInt("price", 0);
            //int i = Integer.parseInt(restoredText);
            y+=priceValue_i;
            editor.putInt("price", y);
            editor.commit();



        u = (TextView)findViewById(R.id.price_value);
        u.setText(Integer.toString(y));
    ...
    public void submit(View v)
    {
        ...
        Toast.makeText(this,"Submitting your Order",Toast.LENGTH_SHORT).show();
        SharedPreferences.Editor editor = sharedpreferences.edit();
        editor.clear();
        editor.commit();

        prefs = getSharedPreferences("display",Context.MODE_PRIVATE);
        SharedPreferences.Editor x = prefs.edit();
        x.clear();
        x.commit();
    ...
    private void makePostRequest(List<NameValuePair> nameValuePair) {
        ...
        HttpPost httpPost = new HttpPost("http://192.168.43.63:8000/submit_order/");
